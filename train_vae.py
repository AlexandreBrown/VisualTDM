...
from torchrl.data.replay_buffers import LazyMemmapStorage, LazyTensorStorage
...
def main(cfg: DictConfig):
    ...
    vae_loss = VAELoss(vae_model, beta=cfg['alg']['kl_divergence_beta'])
    ...
    for data in tqdm(collector):
        ...
        for _ in range(cfg['alg']['optim_steps_per_iter']):
            ...
            print(f"Loss: {loss_result['loss'].item()}")
